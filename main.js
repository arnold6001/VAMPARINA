        ...
        switch (true) {
            ...
            case userMessage.startsWith('.mode'):
                ...
                if (action !== 'public' && action !== 'private') {
                    await sock.sendMessage(chatId, { text: 'Invalid mode! Use .mode public or .mode private' }, { quoted: message });
                    return;
                }
                ...
                try {
                    ...
                    await sock.sendMessage(chatId, { text: `Bot mode changed to *${action}*` }, { quoted: message });
                } catch (error) {
                    console.error('Error updating access mode:', error);
                    await sock.sendMessage(chatId, { text: 'Failed to update bot mode' }, { quoted: message });
                }
                break;
